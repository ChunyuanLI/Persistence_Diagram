...
% dictionary
num_smp = 1e5; % number of sampled descriptors for dictionary learning

%VOCAB_SIZES            = [4 8 16 24 32 48 64];
VOCAB_SIZES            = 48;

% Training set size for kmeans 
VOCAB_TRAININGSET_SIZE = 1e5;
...
addpath(fullfile(SCRIPTS_ROOT_DIR, 'evaluation','robust_performance'));
